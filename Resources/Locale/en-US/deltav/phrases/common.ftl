phrase-group-generic = General
phrase-group-command = Command
phrase-group-engineering = Engineering
phrase-group-epistemics = Science
phrase-group-logistics = Cargo
phrase-group-medical = Medical
phrase-group-security = Security
phrase-group-service = Service
phrase-group-civilian = Civilian
phrase-group-crew = Crew
phrase-group-misc = Miscellaneous
...
phrase-i-dont-understand = I don't understand
phrase-which = Which
phrase-question = Question
phrase-i-understand = I understand
phrase-thats-correct = That's correct
phrase-that-is-incorrect = That's incorrect
phrase-let-me-rephrase = Let me rephrase
phrase-please-listen = Please listen
phrase-group-grammar = Grammar
phrase-also = Also
phrase-and = And
phrase-but = But
phrase-by = By
