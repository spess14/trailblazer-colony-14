...
public sealed partial class MouseRotatorComponent : Component
{
    ...
    public Angle AngleTolerance = Angle.FromDegrees(5.0); // Moffstation - smooth combat mode movement
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public bool Simple4DirMode = false; // Moffstation - smooth combat mode movement
}
