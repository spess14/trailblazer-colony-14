...
public sealed partial class DoorBoltComponent : Component
{
    ...
    public SoundSpecifier BoltUpSound = new SoundPathSpecifier("/Audio/_Moffstation/Machines/boltsup.ogg"); // Moff - nicer airlock sounds

    /// <summary>
    /// Sound to play when the bolts on the airlock go down.
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public SoundSpecifier BoltDownSound = new SoundPathSpecifier("/Audio/_Moffstation/Machines/boltsdown.ogg"); // Moff - nicer airlock sounds
