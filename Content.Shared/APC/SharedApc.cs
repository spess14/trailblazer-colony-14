...
public sealed class ApcBoundInterfaceState(bool mainBreaker,
    ...
    float maxLoad,
    bool tripped,
    bool permaTripped) : BoundUserInterfaceState, IEquatable<ApcBoundInterfaceState> // Moffstation - potato APC cooking
{
    /// <summary>
    ...
    // Moff Start - Potato APC cooking
    /// <summary>
    /// If the APC is unrecoverable after it has been tripped
    /// </summary>
    public readonly bool PermaTripped = permaTripped;
    // Moff End
