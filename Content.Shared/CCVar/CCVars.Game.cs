...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<MinimumJobFallback>
        GameMinimumJobFallback = CVarDef.Create("game.minimum_job_fallback", MinimumJobFallback.None, // Moff - Change default to `None` because that's what we use in production
