...
public sealed partial class SkillPicker : BoxContainer
{
    ...
    public SkillPicker(IReadOnlyDictionary<ProtoId<SkillPrototype>, int>? passions, SpriteSystem sprite)
    {
    ...
    public void RebuildEntries(IReadOnlyDictionary<ProtoId<SkillPrototype>, int>? passions)
    {
        ...
        foreach (var skill in _skills)
        {
            ...
            texture.Texture = _sprite.Frame0(skill.Icon);
            ...
            SkillPassionContainer.AddChild(container);
