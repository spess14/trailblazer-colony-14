...
public sealed partial class ResearchTableWindow : FancyWindow
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        foreach (var pair in _grid)
        {
            var dependant = pair.Value;
            foreach (var dependencyId in dependant.Dependencies)
            {
                var dependency = _grid
                    .Where(i => i.Value.ID == dependencyId)
                    .Select(i => i.Value)
                    .First();
                //TODO draw line without handle.DrawLine
            }
        }
    }
