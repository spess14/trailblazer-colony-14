...
public sealed partial class RandomizeLockButton : BoxContainer
{
    ...
    /// </summary>
    public static HumanoidCharacterProfile.RandomizeCfg RandomizeCfg = HumanoidCharacterProfile.RandomizeCfg.None; // Moff - set to none cuz its a checkbox
    ...
    public RandomizeLockButton()
    {
        ...
        RandomizeCfg = HumanoidCharacterProfile.RandomizeCfg.None; // Moff - set to none cuz its a checkbox

        LockButton.OnToggled += args => HandleToggle(!args.Pressed); // Moff - set to none cuz its a checkbox
    }
