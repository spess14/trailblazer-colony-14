...
public abstract partial class InteractionTest
{
    ...
    // Parts
    protected const string Bin1 = "MatterBinStockPart"; //moffstation - Revert machine parts
    protected const string Cap1 = "CapacitorStockPart"; //moffstation - Revert machine parts
