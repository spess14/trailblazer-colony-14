...
public sealed class MachineConstruction : InteractionTest
{
    ...
    public async Task ConstructProtolathe()
    {
        ...
        await Interact(ProtolatheBoard, Bin1, Bin1, Manipulator1, Manipulator1, Beaker, Beaker, Screw); //moffstation - Revert machine parts
    ...
    public async Task DeconstructProtolathe()
    {
        ...
        await AssertEntityLookup(
            ...
            (Cable, 1),
            (Beaker, 2),
            (Manipulator1, 2), //moffstation - Revert machine parts
            (Bin1, 2), //moffstation - Revert machine parts
            (ProtolatheBoard, 1));
    }
    ...
    public async Task ChangeMachine()
    {
        ...
        AssertPrototype(MachineFrame);
        await Interact(Bin1, Bin1, Bin1, Manipulator1, Glass, Screw); //moffstation - Revert machine parts
